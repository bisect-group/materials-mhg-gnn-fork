...
from mhg_model.graph_grammar.io.smi import hg_to_mol
from mhg_model.models.mhgvae import GrammarGINVAE
...
def load() -> Optional[
    ...
    file_path = hf_hub_download(repo_id="ibm/materials.mhg-ged", filename="pytorch_model.bin")
